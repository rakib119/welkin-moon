                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="is_featured"> Is Featured?
                                                            <input  id="is_featured" type="checkbox" {{ $team->is_featured ==1?'checked':''}}  name="is_featured" value="1">
                                                        @error('is_featured')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="in_home"> Show in Home
                                                            <input id="in_home" name="in_home" type="checkbox" {{$team->in_home ==1?'checked':''}}  value="1">
                                                        @error('in_home')
                                                            <h6 class="text-danger"> {{ $message }}</h6>
                                                        @enderror
                                                    </div>
