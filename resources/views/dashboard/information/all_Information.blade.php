            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="first_name" type="text" class="form-control"
                            value="{{$personal_info->first_name}}"  name="first_name"  >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="Last_name" type="text" class="form-control"
                            value="{{$personal_info->Last_name}}"  name="Last_name" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="email" type="text" class="form-control"
                            value="{{$personal_info->email}}"  name="email" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="phone_number" type="text" class="form-control"
                            value="{{$personal_info->phone_number}}"  name="phone_number" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" for="gender">Gender
                            ...
                            value="{{$personal_info->gender}}"  name="gender" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" >Present Address
                            ...
                            class="form-control">{{$personal_info->present_address}}</Textarea>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" >Permanent  Address
                            ...
                            class="form-control">{{$personal_info->permanent_address}}</Textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly  id="nid_or_dob_number" type="text" class="form-control"
                            value="{{$personal_info->nid_or_dob_number}}" name="nid_or_dob_number"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly  id="marital_status" type="text" class="form-control"
                            value="{{$personal_info->marital_status}}" name="marital_status"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly  id="zip_code" type="text" class="form-control"
                            value="{{$personal_info->zip_code}}" name="zip_code"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly  id="occupation" type="text" class="form-control"
                            value="{{$personal_info->occupation}}" name="occupation"
                            >
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly  id="religion" type="text" class="form-control"
                            value="{{$personal_info->religion}}" name="religion"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly  id="police_station" type="text" class="form-control"
                            value="{{$personal_info->police_station}}" name="police_station"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="number_of_duty_officer" type="text" class="form-control"
                            value="{{$personal_info->number_of_duty_officer}}" name="number_of_duty_officer"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="fire_service_name" type="text" class="form-control"
                            value="{{$personal_info->fire_service_name}}" name="fire_service_name"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="fire_service_number" type="text" class="form-control"
                            value="{{$personal_info->fire_service_number}}" name="fire_service_number"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="Upazila_Hospital_Name" type="text" class="form-control"
                            value="{{$personal_info->Upazila_Hospital_Name}}" name="Upazila_Hospital_Name"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="Upazila_Hospital_number" type="text" class="form-control"
                            value="{{$personal_info->Upazila_Hospital_number}}" name="Upazila_Hospital_number"
                            >
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/personal/$personal_info->picture")}}" style="height:50px; width:50px;" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/personal/$personal_info->nid_or_dob_font")}}" style="height:50px; width:50px;" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/personal/$personal_info->nid_back")}}" style="height:50px; width:50px;">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" for="NID_Card_Or_DOB_Attested_copy">NID Card Or DOB Attested copy
                            ...
                            <br>
                            <img src="{{asset("assets/images/information/personal/$personal_info->NID_Card_Or_DOB_Attested_copy")}}" style="height:50px; width:50px;">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/personal/$personal_info->education_certificate")}}" style="height:50px; width:50px;">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/personal/$personal_info->statement")}}" style="height:50px; width:50px;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="father_name" type="text" class="form-control"
                            value="{{$father_info->father_name}}" name="father_name"  >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="father_phone_number" type="text" class="form-control"
                            value="{{$father_info->father_phone_number}}"  name="father_phone_number"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="father_occupation" type="text" class="form-control" value="{{$father_info->father_occupation}}"  name="father_occupation" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="father_dob" type="date" class="form-control" value="{{$father_info->father_dob}}" name="father_dob" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" >Father Present Address </label>
                        <Textarea readonly name="father_present_address" id="father_present_address" class="form-control">{{$father_info->father_present_address}}</Textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" >Father Permanent  Address </label>
                        <Textarea readonly    name="father_permanent_address" id="father_permanent_address" class="form-control">{{$father_info->father_permanent_address}}</Textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/father/$father_info->father_picture")}}" style="height:50px; width:50px;">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="father_nid_or_passport" type="text" class="form-control"
                            value="{{$father_info->father_nid_or_passport}}"  name="father_nid_or_passport"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                         <img src="{{asset("assets/images/information/father/$father_info->father_nid_or_passport_image")}}" style="height:50px; width:50px;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="mother_name" type="text" class="form-control"
                            value="{{$mother_info->mother_name}}" name="mother_name"  >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="mother_phone_number" type="text" class="form-control"
                            value="{{$mother_info->mother_phone_number}}"  name="mother_phone_number"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="mother_occupation" type="text" class="form-control"
                            value="{{$mother_info->mother_occupation}}"  name="mother_occupation"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="mother_dob" type="date" class="form-control"
                            value="{{$mother_info->mother_dob}}" name="mother_dob"
                             >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" >Mother Present Address
                            ...
                            class="form-control">{{$mother_info->mother_present_address}}</Textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" >Mother Permanent  Address
                            ...
                            class="form-control">{{$mother_info->mother_permanent_address}}</Textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label" for="mother_picture">Mother Picture
                            ...
                            <br>
                            <img src="{{asset("assets/images/information/mother/$mother_info->mother_picture")}}" style="height:50px; width:50px;">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input readonly id="mother_nid_or_passport" type="text" class="form-control"
                            value="{{$mother_info->mother_nid_or_passport}}"  name="mother_nid_or_passport"
                            >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <br>
                        <img src="{{asset("assets/images/information/mother/$mother_info->mother_nid_or_passport_image")}}" style="height:50px; width:50px;">
