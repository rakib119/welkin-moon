            ...
            <div id="rev_slider_4_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>
                    <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-description="">
                        <img src="{{asset('assets')}}/images/resources/slide-bg2.jpg" alt="Slide Background 2" class="rev-slidebg img-fluid" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        ><img height="450" width="779" src="{{asset('assets')}}/images/slide2-shp1.png" alt="Slide 2 Shape 1">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-1"
                             ...
                             data-paddingbottom="[0,0,0,0]"
                             data-paddingleft="[0,0,0,0]"
                        ><img height="236" width="415" src="{{asset('assets')}}/images/slide2-shp2.png" alt="Slide 2 Shape 2">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 4;"
                        ><img height="73" width="35" src="{{asset('assets')}}/images/slide2-mckp1.png" alt="Slide 2 Mockup 1">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="82" width="41" src="{{asset('assets')}}/images/slide2-mckp2.png" alt="Slide 2 Mockup 2">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="92" width="43" src="{{asset('assets')}}/images/slide2-mckp3.png" alt="Slide 2 Mockup 3">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-1"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="100" width="45" src="{{asset('assets')}}/images/slide2-mckp4.png" alt="Slide 2 Mockup 4">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="216" width="57" src="{{asset('assets')}}/images/slide2-mckp5.png" alt="Slide 2 Mockup 5">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="322" width="230" src="{{asset('assets')}}/images/slide2-mckp6.png" alt="Slide 2 Mockup 6">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 2;"
                        ><img height="256" width="352" src="{{asset('assets')}}/images/slide2-mckp7.png" alt="Slide 2 Mockup 7">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingbottom="[0,0,0,0]"
                             data-paddingleft="[0,0,0,0]"
                        ><img height="389" width="256" src="{{asset('assets')}}/images/slide2-mckp8.png" alt="Slide 2 Mockup 8">
                        </div>
                    ...
                    <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""
                        data-description="">
                        <img src="{{asset('assets')}}/images/resources/slide-bg3.png" alt="Slide Background 3" class="rev-slidebg img-fluid" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-1"
                             ...
                             data-paddingbottom="[0,0,0,0]"
                             data-paddingleft="[0,0,0,0]"
                        ><img height="700" width="760" src="{{asset('assets')}}/images/slide3-shp1.png" alt="Slide 3 Shape 1">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 5;"
                        ><img height="367" width="367" src="{{asset('assets')}}/images/slide3-mckp1.png" alt="Slide 3 Mockup 1">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="379" width="534" src="{{asset('assets')}}/images/slide3-mckp2.png" alt="Slide 3 Mockup 2">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 4;"
                        ><img height="314" width="287" src="{{asset('assets')}}/images/slide3-mckp3.png" alt="Slide 3 Mockup 3">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-1"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 4;"
                        ><img height="305" width="330" src="{{asset('assets')}}/images/slide3-mckp4.png" alt="Slide 3 Mockup 4">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="437" width="412" src="{{asset('assets')}}/images/slide3-mckp5.png" alt="Slide 3 Mockup 5">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 1;"
                        ><img height="313" width="133" src="{{asset('assets')}}/images/slide3-mckp6.png" alt="Slide 3 Mockup 6">
                        </div>
                        ...
                        <div class="tp-caption img-layer tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 3;"
                        ><img height="213" width="122" src="{{asset('assets')}}/images/slide3-mckp7.png" alt="Slide 3 Mockup 7">
                        </div>
            ...
            <div class="market-facts-wrap position-relative w-100">
                <div class="row align-items-end">
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="mckp-img text-center tilt w-100" data-max_tilt="10" data-perspective="1000" data-scale="1" data-speed="700"><img class="img-fluid" src="{{asset('assets')}}/images/resources/market-fact-mckp.png" alt="Market Facts Mockup" height="614" width="565"></div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="text-box w-100">
                            <div class="sec-title w-100 position-relative">
...
<section>
    <div class="w-100 pt-50 pb-20 position-relative">
        ...
        <div class="particles-wrap position-absolute w-100">
            <div id="particle-2" class="particles-js top_left mx-w50 w-100" data-color="#3E4A59" data-size="70" data-count="2" data-speed="2" data-hide="767" data-shape="image" data-mode="bounce" data-image-url="{{asset('assets')}}/images/particle-2.png" data-image-width="133" data-image-height="133">
                <canvas></canvas>
            </div>
        </div><!-- Particles Wrap -->
        <div class="container">
            <div class="market-wrap position-relative w-100">
                <div class="row align-items-center">
                    <div class="col-md-12 col-sm-12 col-lg-6 order-lg-1">
                        <div class="mckp-img text-center tilt w-100" data-max_tilt="10" data-perspective="1000" data-scale="1" data-speed="700"><img class="img-fluid" src="{{asset('assets')}}/images/resources/marketing-strg-mckp.png" alt="Marketing Strategy Mockup" height="434" width="574"></div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-6">
    ...
    <div class="w-100 pt-120 pb-120 position-relative">
        ...
        <div class="container">
            <div class="structure-wrap w-100">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="mckp-img text-center tilt w-100" data-max_tilt="10" data-perspective="1000" data-scale="1" data-speed="700"><img class="img-fluid" src="{{asset('assets')}}/images/resources/structure-mckp.png" alt="Structure Mockup" height="532" width="507"></div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-6">
                        <div class="text-box w-100">
                            <div class="sec-title w-100 position-relative">
                ...
                <div class="row mrg30">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-3">
                        <div class="team-box text-center position-relative w-100">
                            <div class="team-img w-100"><a href="javascript:void(0);" title=""><img class="img-fluid w-100" src="{{asset('assets/images/teams')."/".$team->img}}" alt="image not found" height="300" width="300"></a></div>
                            <div class="team-info w-100">
                                ...
                                <div class="social-links v2 d-inline-flex flex-wrap">
                                    <a href="{{$team->facebook}}" title="Facebook" target="_blank"><i class="flaticon-facebook"></i></a>
                                    <a href="{{$team->twitter}}" title="Twitter" target="_blank"><i class="flaticon-twitter-letter-logo"></i></a>
                                    <a href="{{$team->linkedin}}" title="Linkedin" target="_blank"><i class="flaticon-telegram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
