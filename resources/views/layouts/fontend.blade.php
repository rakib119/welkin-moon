                                ...
                                <div class="widget w-100">
                                    ...
                                    <ul class="footer-contact-lisst list-unstyled mb-0 w-100">
                                        <li><i class="fa fa-home"></i> <a href="mailto:info@example.com"
                                                title="Address">Dhaka,Bangladesh</a></li>
                                        <li><i class="fa fa-globe"></i><a href="https://www.welkinmoon.com"
                                                title="website">https://www.welkinmoon.com </a></li>
                                        <li><i class="flaticon-telephone-auricular-with-cable"></i><a
                                                href="tel:+8801764895137" title="Mobile Number">+8801764895137</a></li>
                                        <li><i class="flaticon-email"></i><a href="mailto:info@example.com"
                                                title="email">info@welkinmoon.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-lg-3">
